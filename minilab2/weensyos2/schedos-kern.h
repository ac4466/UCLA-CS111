...
typedef struct process {
	...
	unsigned p_priority;		// Exercise 4A: Process's priority level
	unsigned p_share;		// Exercise 4B: Process's share
	unsigned p_currentShare;	// Exercise 4B: Process's current share
} process_t;
